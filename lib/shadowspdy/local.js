...
(function() {
  var connections, createServer, fs, inet, inetAton, inetNtoa, net, spdy, streamIdCount, utils;
  ...
  createServer = function(serverAddr, serverPort, port, key, method, timeout, local_address) {
    var createStream, getConnection, server, _connection, _socket;
      ...
      connection.on("data", function(data) {
        ...
        if (stage === 1) {
          try {
            ...
            remote = createStream(getConnection(), function() {
