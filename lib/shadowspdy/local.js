...
(function() {
  var connectionIdCount, createServer, currentConnections, fs, inet, inetAton, inetNtoa, net, spdy, streamIdCount, utils;
      ...
      if (Object.keys(_connections).length >= connections) {
        ...
        _socket = net.connect({
          ...
          connection.on('error', function(err) {
            ...
            utils.error(err);
            connection.destroy();
            return delete _connections[connection.connectionId];
          });
