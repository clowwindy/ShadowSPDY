...
(function() {
  var connectionIdCount, createServer, currentConnections, encrypt, fs, inet, inetAton, inetNtoa, net, spdy, streamIdCount, utils;
  ...
  createServer = function(serverAddr, serverPort, port, key, method, timeout, local_address, connections) {
    ...
    getConnection = function(callback) {
      ...
      _socket = net.connect({
        ...
        return _socket.on('close', function(err) {
          return delete _connections[connection._connectionId];
        });
      });
